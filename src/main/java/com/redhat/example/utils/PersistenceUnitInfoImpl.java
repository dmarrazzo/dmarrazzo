...
public class PersistenceUnitInfoImpl implements PersistenceUnitInfo {
    ...
    public static PersistenceUnitInfoImpl newPersistenceUnitInfo(String persistenceUnitName,
            List<String> managedClassNames, Properties properties, DataSource dataSource) {
        PersistenceUnitInfoImpl persistenceUnitInfo = new PersistenceUnitInfoImpl(persistenceUnitName,
                managedClassNames, properties);
        persistenceUnitInfo.jtaDataSource = null;
        persistenceUnitInfo.nonJtaDataSource = dataSource;
